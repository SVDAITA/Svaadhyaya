...
function VidyaBg({ isDark }) {
  ...
  return (
    <svg width="420" height="300" viewBox="0 0 420 300" fill="none"
      ...
      <path d="M180 240 Q220 200 260 240" stroke={COLOR} strokeWidth="1" fill="none" />
      <path d="M180 240 L180 80 Q220 60 260 80 L260 240" stroke={COLOR} strokeWidth="1" fill="none" />
      <line x1="220" y1="65" x2="220" y2="240" stroke={COLOR} strokeWidth="1.5" />
      {[0,1,2,3,4,5,6].map((i) => (
        <line key={`l${i}`} x1="188" y1={100+i*18} x2="216" y2={100+i*18} stroke={COLOR} strokeWidth="0.6" opacity="0.7" />
      ))}
      {[0,1,2,3,4,5,6].map((i) => (
        <line key={`r${i}`} x1="224" y1={100+i*18} x2="252" y2={100+i*18} stroke={COLOR} strokeWidth="0.6" opacity="0.7" />
      ))}
      <rect x="310" y="220" width="80" height="12" rx="2" stroke={COLOR} strokeWidth="0.75" fill="none" />
      <rect x="316" y="208" width="72" height="12" rx="2" stroke={COLOR} strokeWidth="0.75" fill="none" />
      <rect x="322" y="196" width="64" height="12" rx="2" stroke={COLOR} strokeWidth="0.75" fill="none" />
      <circle cx="370" cy="100" r="35" stroke={COLOR} strokeWidth="0.75" fill="none" />
      <circle cx="370" cy="100" r="20" stroke={COLOR} strokeWidth="0.5" fill="none" />
  ...
  return (
    <Box sx={{ minHeight:"100vh",position:"relative",overflow:"hidden" }}>
      ...
      <Box sx={{ p:{xs:2,md:3} }}>
        ...
        {tab === 0 && (
          <>
            <AreaBanner color={safeColor} emoji="📚" title="Vidyā" subtitle={subtitle} />
